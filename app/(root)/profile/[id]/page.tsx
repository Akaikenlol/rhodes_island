...
const ProfilePage = async ({ params }: ProfilePageProps) => {
	...
	return (
		<>
			{/* <div className="text-center flex px-16 py-8 flex-col bg-gradient-to-t from-amber-50 to-cyan-50 gap-3">
				<div className="grid lg:grid-cols-2 sm:grid-rows-1 gap-20 max-sm:grid-rows-2 max-sm:w-auto">
